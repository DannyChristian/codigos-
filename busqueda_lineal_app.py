...
st.write('## Gráfica de Tiempo Total vs Tamaño del Arreglo')
plt.figure(figsize=(10, 6))
plt.plot(df_resultados['Tamaño del arreglo'], df_resultados['Tiempo total (s)'], marker='o')
plt.xlabel('Tamaño del arreglo')
plt.ylabel('Tiempo total (s)')
plt.title('Tiempo Total vs Tamaño del Arreglo')
plt.grid(True)
st.pyplot(plt)
